...
$countSql = "SELECT COUNT(*) FROM scholarships WHERE level = 'bachelor'";
if ($search) {
...
$sql = "SELECT * FROM scholarships WHERE level = 'bachelor'";
if ($search) {
...
<html>
<head>
    <title>BSc Scholarships</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body class="bg-light">
<div class="container mt-4">
    <h2 class="text-primary">Bachelor Scholarships</h2>
    ...
    <?php while ($row = $result->fetch_assoc()): ?>
        <div class="card mb-3 shadow-sm">
            <div class="card-body">
                ...
                <p><?= $row['description'] ?></p>
                <a href="<?= $row['link'] ?>" target="_blank" class="btn btn-sm btn-primary">Apply Now</a>
            </div>
        </div>
    <?php endwhile; ?>
